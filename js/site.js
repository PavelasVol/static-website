...
function createMobileZoomControls() { // не используется
    ...
    if (!isMobile) {
        console.log('createMobileZoomControls: не мобильное устройство');
        return;
    }
    ...
    console.log('controls position:', controls.style.position);
    console.log('controls right:', controls.style.right);
    console.log('controls bottom:', controls.style.bottom);

    // Обновляем состояние кнопок
    setTimeout(updateZoomButtonsState, 100);
}
...
function resetMapZoom() {
    console.log('resetMapZoom: сброс масштаба');
    mapScale = 1;
    mapTranslateX = 0;
    mapTranslateY = 0;
    applyMapTransform();
...
function updateZoomButtonsState() {
    ...
    if (!zoomInBtn || !zoomOutBtn || !resetBtn) {
        console.log('updateZoomButtonsState: кнопки не найдены');
        return;
    }
...
mass2_0m[4] = new Array(46.90, 44.69);
mass2_0m[5] = new Array(42.32, 54.60);
mass2_0m[6] = new Array(41.52, 49.44);
mass2_0m[7] = new Array(45.84, 56.27);
mass2_0m[8] = new Array(44.27, 57.26);
mass2_0m[9] = new Array(43.54, 56.12);
mass2_0m[10] = new Array(42.40, 56.46);
mass2_0m[11] = new Array(45.23, 52.09);
mass2_0m[12] = new Array(44.37, 51.01);
mass2_0m[13] = new Array(46.58, 54.11);
mass2_0m[14] = new Array(43.94, 54.65);
mass2_0m[15] = new Array(40.24, 54.22);
mass2_0m[16] = new Array(44.47, 53.37);
mass2_0m[17] = new Array(40.67, 51.89);
mass2_0m[18] = new Array(38.22, 49.42);
mass2_0m[19] = new Array(39.18, 48.97);
mass2_0m[20] = new Array(42.59, 49.42);
mass2_0m[21] = new Array(37.85, 48.00);
mass2_0m[22] = new Array(55.95, 56.02);
mass2_0m[23] = new Array(50.79, 49.97);
mass2_0m[24] = new Array(53.52, 46.06);
mass2_0m[25] = new Array(46.64, 50.52);
mass2_0m[26] = new Array(44.14, 48.48);
mass2_0m[27] = new Array(36.09, 52.39);
mass2_0m[28] = new Array(37.82, 52.11);
mass2_0m[29] = new Array(41.33, 51.09);
mass2_0m[30] = new Array(46.47, 47.10);
mass2_0m[31] = new Array(48.82, 47.96);
mass2_0m[32] = new Array(51.23, 46.99);
mass2_0m[33] = new Array(49.45, 45.97);
mass2_0m[34] = new Array(55.50, 46.65);
mass2_0m[35] = new Array(56.27, 48.92);
mass2_0m[36] = new Array(56.51, 50.94);
mass2_0m[37] = new Array(51.35, 51.60);
mass2_0m[38] = new Array(29.89, 53.28);
mass2_0m[39] = new Array(33.25, 49.42);
mass2_0m[40] = new Array(30.08, 47.41);
mass2_0m[41] = new Array(38.01, 53.63);
mass2_0m[42] = new Array(25.35, 45.03);
mass2_0m[43] = new Array(37.83, 50.27);
mass2_0m[44] = new Array(41.05, 54.90);
mass2_0m[45] = new Array(41.77, 47.46);
mass2_0m[46] = new Array(43.61, 41.45);
mass2_0m[47] = new Array(43.34, 53.80);
mass2_0m[48] = new Array(39.21, 52.07);
mass2_0m[49] = new Array(40.80, 52.75);
mass2_0m[50] = new Array(48.53, 49.66);
mass2_0m[51] = new Array(48.57, 45.40);
mass2_0m[52] = new Array(48.04, 46.11);
mass2_0m[53] = new Array(50.34, 46.20);
mass2_0m[54] = new Array(42.32, 52.56);
mass2_0m[55] = new Array(39.56, 53.49);
mass2_0m[56] = new Array(39.03, 46.58);
mass2_0m[57] = new Array(34.80, 47.63);
mass2_0m[58] = new Array(35.86, 48.63);
mass2_0m[59] = new Array(43.84, 52.48);
mass2_0m[60] = new Array(43.46, 53.05);
mass2_0m[61] = new Array(45.85, 58.12);
...
// Подробное описание объекта
    ...
    names_arr2 = new Array("",
        ...
        "Вход в тоннель охранялся и охраняется от коров (после войны) и случайных (или неслучайных) людей специальной военнизированной службой.",
        "Лодочная станция и причал были введены в строй в 1975 году. Лодки размещались в гараже под прибрежным кафе. Лодки краном ставили на ж/д тележку, везли метров 30 до крана под навесом, который уже опускал в воду. ",
        ...
        "На первом этаже этого 5-этажного дома размещался Военторг - магазин для военнослужащих и магазин продовольственных товаров. На остальных этажах проживали семьи обслуживающего персонала Санатория. Сейчас здесь живут как местные жители, так и россияне, купившие здесь квартиры. В 2020-е годы на первом этаже располагался продовольственный магазин и летнее кафе. Этот дом восстановил свою живучесть.",
        "На первом этаже этого 5-этажного дома находилась Столовая для отдыхающих в Пансионате. На остальных этажах проживали семьи обслуживающего персонала Санатория. Главным поваром здесь была тетя Ася, которая до сих пор готовит изумительные по вкусу блюда. Сейчас этот дом стоит безжизненно взирая пустыми глазницами оконных проемов на окружающую жизнь...",
        ...
        "Дикий дальний пляж",
        "Подобные Смотровые беседки были расположены на склоне горы и находились вблизи спусков от корпусов Санатория к морю.",
        "Прибрежная аллея идет вдоль всех пляжей, начиная от впадания реки Дзиеты в море до насосной станции. В 2010-20-ее годы часть аллеи повреждена из-за разрушения части берега под Титаником. ",
        ...
        "Чуть ниже Генеральского домика располагалась небольшая зона отдыха для посетителей Генеральского домика",
        "Телефонная станция обслуживала все корпуса Санатория и располагалась напротив Столовой-Зимнего клуба, имела два входа со стороны аллеи. Телефонные номера были трехзначными.",
...
// Комментарии к конкретным фотографиям объектов
    ...
    names_arr3[7] = new Array("", "Лечебный корпус до войны", "Прием у врача", "Прием у врача Неборского", "В кабинете функциональной диагностики", "Гидромассаж", "Принятие лечебных ванн", "В массажном кабинете", "Душ Шарко", "Циркулярный душ", "В рентгеновском кабинете", "Анализ рентгеновских снимков", "В кабинете токов низкой частоты", "В кабинете токов УВЧ", "В ингаляторном кабинете", "В кабинете грязелебницы", "На приеме у зубного врача В.М.Петрова", "В лаборатории", "В лаборатории", "В аптеке", "Лечебный корпус после войны", "Лечебный корпус и фонтан после войны", "Лечебный корпус с восточной стороны", "Лечебный корпус после войны и коровы", "Разруха в Лечебном корпусе после войны", "Лечебный корпус  до войны  1950-55г","Коллектив лечебного корпуса в 1963 году")
    ...
    names_arr3[20] = new Array("", "Центральная аллея до войны", "Центральная аллея после войны", "Ноги Ленина?", "Ограда вдоль Центральной аллеи", "Ограда вдоль Центральной аллеи", "Частный снимок до войны. На аллее 1980 г", "Частный снимок до войны. В парке 1980 г", "Частный снимок до войны 1980 г", "Частный снимок до войны. В парке на скамейке 1980 г", "После войны", "После войны", "Дерево упавшее на баллюстраду вдоль главной аллеи в 2026 году","На аллее. Частный снимок.")
    ...
    names_arr3[27] = new Array("", "Причал со стороны пляжа до войны", "Причал со стороны пляжа до войны", "Причал со стороны пляжа после войны", "Причал со стороны Лодочной станции после войны", "Причал после войны", "Причал после войны", "Лодочная станция после войны", "Лодочная станция после войны", "Рельсы от Лодочной станции к Причалу после войны", "Причал со стороны пляжа", "Вид на причал со стороны моря","Прыжки с крыши причала до середины 2020-х годов")
    ...
    names_arr3[34] = new Array("", "Магазин Военторг на 1-м этаже и квартиры работников санатория", "Магазин после войны в 21 веке", "Частный снимок на фоне магазина до войны", "2026 год","В магазине Военторг до войны. Тетя Маруся, тетя Эмма и девочка Оксана. Из частного снимка.")
    ...
    names_arr3[38] = new Array("", "Море со стороны прибрежной аллеи", "Чистое море", "Чистое море", "Частный снимок в море в 1982 году", "Штормит", "Штормит", "Штормит", "Закат", "Закат", "Закат", "Ночью","Вертолет над морем")
    names_arr3[39] = new Array("", "В 1950-е годы", "В 1982 году", "До войны", "После войны","До войны. Частный снимок.")
    ...
    names_arr3[50] = new Array("", "1949 г. Вход в главный санаторий", "1951 г. Деревянные коттеджи", "1951 г. Домик", "1954 г. У столовой", "1956 г. У скульптурной группы.", "1957 г.Финский домик", "1959 г. Зимний клуб", "Особняк князя Ковалевского в 1949 году, с которого начинался Санаторий", "Коллектив персонала Санатория до войны","Купание коней в 1955 году","Благоустройство санатория в 1955 году")
