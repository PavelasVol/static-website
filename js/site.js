...
names_arr = new Array("",
    ...
    "14. Теннистный корт",
    "15. Нижняя (у моря) Бадмингтонная площадка",
...
names_arr2 = new Array("",
    ...
    "Нижняя Бадмингтонная площадка до войны была расположена вместе с волейбольной площадкой вдоль набережной аллеи под Титаником. Теперь от нее остался только фундамент.",
    ...
    "Двухэтажный Генеральский домик располагался в отдалении от большинства корпусов в западной части Санатория. С нему шла аллея от Центрального входа. Со второго этажа Генеральского домика открывался прекрасный вид на море. В домике было 4 номера: с южной стороны два больших с террасой и видом на море и с восточной стороны два малых с балкончиками. В центре домика располагался открытый бассейн с морской водой. В северной стороне домика размещались деловая комната, зона отдыха, открытая терраса, столовая.",
...
names_arr3[15] = new Array("", "До войны Бадминтонная площадка у моря (нижняя) видна на заднем плане за Волейбольной площадкой", "Место бадмингтонной площадки в 2026 году", "Фундамент под бадмингтонную площадку в 2026 году")
